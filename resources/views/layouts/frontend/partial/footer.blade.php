    ...
    <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <p> <i class="fas fa-map-marker-alt"></i> Search, Oporto - Portugal</p>
            <p><i class="fas fa-phone"></i> +351 111111112</p>
            <p><i class="fas fa-envelope"></i> someonesname@mail.com</p>
          </div>
        ...
        <p class="text-center pb-2 mb-0"> &copy;Search Website<b></b></p>
      </div>
    </section>
</footer>

      ...
      <div class="col-md-6 col-lg-6  col-sm-8 col-xs-8">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="ID number" name="nid" value="{{ old('nid') }}">
            </div>

            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="contact (please add country code before number)" name="contact" value="{{ old('contact') }}">
            </div>
            ...
            <div class="input-group mb-3">
                <input id="password" type="password" class="form-control" placeholder="password (must have 8 digits)" name="password">
            </div>
